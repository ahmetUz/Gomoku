...
// Uses 6 x uint64_t to represent 361 cells (6 * 64 = 384 >= 361).
class Bitboard {
public:
...
class BitboardIterator {
public:
    BitboardIterator() : bits_{}, word_idx_(6), current_word_(0) {}
    BitboardIterator(const uint64_t bits[6], int start_word);
